...
| [proxmox_virtual_environment_node.server](https://registry.terraform.io/providers/bpg/proxmox/latest/docs/data-sources/virtual_environment_node) | data source |
