...
| Name | Type |
|------|------|
| [proxmox_virtual_environment_container.blocky](https://registry.terraform.io/providers/bpg/proxmox/latest/docs/resources/virtual_environment_container) | resource |
| [terraform_data.blocky_install](https://registry.terraform.io/providers/hashicorp/terraform/latest/docs/resources/data) | resource |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_blocky_ct"></a> [blocky\_ct](#input\_blocky\_ct) | n/a | <pre>object({<br/>    vmid   = number<br/>    cores  = number<br/>    memory = number<br/>    disk   = number<br/>    ip     = string<br/>  })</pre> | n/a | yes |
...
| <a name="input_k3s_server_ip"></a> [k3s\_server\_ip](#input\_k3s\_server\_ip) | K3s server IP for wildcard DNS resolution | `string` | n/a | yes |
